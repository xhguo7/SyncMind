...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default='independent',
        help='AI agent out-of-sync recovery method: independent | collaborative',
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Path to the dataset that you would like to run SyncMind on'
    )
    ...
    # Cost awareness
    logger.info("---------- Cost Awareness ----------")
    logger.info(f"        Max-turn Limit:  {args.max_iterations} turns")
    logger.info(f"        Credit:          ${RESOURCE_AWARENESS['total_credit']}")
    ...
    details = {
        ...
        'total_credit': RESOURCE_AWARENESS['total_credit'], 
