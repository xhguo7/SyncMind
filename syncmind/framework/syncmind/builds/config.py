...
class SyncMindConfig:
    ...
    def init_instance_path(
        ...
        self.resync_output_save_dir = os.path.dirname(os.path.abspath(__file__)).split('evaluation')[0] + f"evaluation/syncmind_{self.agent_model}_max{max_iterations}turn_budget{RESOURCE_AWARENESS['total_budget']}_code{RESOURCE_AWARENESS['coding_cost']}_ask{RESOURCE_AWARENESS['asking_cost']}/{self.save_dir_name}/"
