...
from evaluation.syncmind.builds.aligner import align_agent_context
...
from evaluation.syncmind.builds.loader import DockerHandler
...
class DockerEvaluator(DockerManager):
    ...
    def __init__(self, instance: Series, test_result: dict) -> None:
        ...
        self.container = None
        self.container_id = ''
        self.container_name = f"{self.image_name}__xuehang_evaluator__{str(time.ctime()).replace(':', '_').replace(' ', '_')}"
