...
export PYTHONPATH="${PYTHONPATH}:./evaluation/benchmarks/syncbench"
# export PYTHONPATH="/shared/nas2/xuehangg/envs/poetry_venv/openhands-ai-OEMRRbiK-py3.12/lib/python3.12/site-packages"

COMMAND="PYTHONDONTWRITEBYTECODE=1 poetry run python evaluation/benchmarks/syncbench/run_infer.py \
  --agent-cls $AGENT \
